...
function initDistributionPage() {
    ...
    function buildDistributionTable() {
        ...
        if (detailItems.length === 0) {
            ...
            detailItems.forEach((item, index) => {
                ...
                let rowHTML = `<tr class="item-row" data-total-quantity="${totalQuantity}">`;
                ...
                const errorClass = distributedQuantity > totalQuantity ? 'error' : '';
    ...
    function sortFloors(a, b) {
        const getFloorParts = (floorStr) => {
            ...
            return { building: buildingPrefix, type: floorType, num: parseInt(numStr, 10), original: s };
        };

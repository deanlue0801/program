...
const routes = {
    ...
    '/quotes/import-cost': { html: 'pages/quotes/import-cost.html', init: 'initQuotesImportCostPage', title: '廠商詢價管理' },
    '/quotes/analysis': { html: 'pages/quotes/analysis.html', init: 'initQuotesAnalysisPage', title: '對業主報價與利潤分析' },
